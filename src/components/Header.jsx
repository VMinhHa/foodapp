...
const Header = () => {
  ...
  const logout = () => {
    ...
    // localStorage.clear(); //Xoa tat ca localStorage
                  ...
                  isMenu && (
                    ...
                    
                    {
                      ...
                      <ul className='flex flex-col'>
                          <li className='menu-list hover:bg-slate-100 px-4 py-2'
                            onClick={() => setIsMenu(false)}
                          >Home</li>
                          <li className='menu-list hover:bg-slate-100 px-4 py-2'
                            onClick={() => setIsMenu(false)}
