    ...
    <section className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full' id="home">
      <div className='py-2 flex-1 flex flex-col items-start justify-center gap-6'>
        ...
        <p className="text-[2.5rem] lg:text-[4.5rem] font-bold tracking-wide text-headingColor">
          ...
          <span className="text-orange-600 text-[3.4rem] lg:text-[5rem]">Your City</span>
        </p>

        <p className='text-base text-textColor text-center md:text-left md:w-[80%]'>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem cupiditate sint ut quas minus deleniti, incidunt dolor itaque facere consequuntur doloremque dicta, veritatis tempore, repellat vel. Ab pariatur obcaecati doloribus.
        </p>
      ...
      <div className='py-2 flex-1 flex items-center relative'>
          <img 
            src={HeroBg} className="ml-auto h-420 w-full lg:w-auto lg:h-650" 
            alt="hero-bg"
          />     
          ...
          <div className='w-full h-full absolute top-0 left-0 flex items-center justify-center lg:px-32 py-4 gap-2 flex-wrap'>
            { heropData && heropData.map((n) => (
              <div key={n.id} className=' lg:w-190 min-w-[160px] p-4 bg-cardOverlay backdrop-blur-md rounded-3xl 
